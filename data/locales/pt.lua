locale = {
  ...
  translation = {
    ...
    ["Authenticator Token"] = "Chave de autenticação",
    ["Author"] = "Autor",
    ...
    ["Battle"] = "Batalha",
    ["Browse Field"] = "Procurar neste local",
    ["Browse"] = "Navegar",
    ...
    ["Connection timed out. Either your network is failing or the server is offline."] = "Conexão expirou. Ou sua conexão está com problema ou o server está offline.",
    ["Console"] = "Console",
    ["Cooldown"] = "Cooldown",
    ["Cooldowns"] = "Cooldowns",
    ...
    ["Detail"] = "Detalhe",
    ["Details"] = "Detalhes",
    ["Disable chat mode, allow to walk using ASDW"] = "Desativar o chat, habilitar movimento utilizando ASDW",
    ...
    ["Display player mana bar"] = "Exibir mana dos jogadores",
    ...
    ["Host"] = "Host",
    ["Hotkeys"] = "Atalhos",
    ["Hotkey delay: %dms"] = "Atraso em hotkey: %dms",
    ["Hotkey delay: %sms"] = "Atraso em hotkey: %sms",
    ...
    ["Make sure that your client uses\nthe correct game client version"] = "Tenha certeza que o seu cliente use\na mesma versão do servidor do jogo",
    ...
    ["Show Top Menu"] = "Exibir o menu principal",
    ...
    ["Stay logged during session"] = "Continuar conectado",
    ["Stamina"] = "Vigor",
    ...
    ["Type"] = "Tipo",
    ["Turn delay: %dms"] = "Atraso ao virar: %dms",
    ["Turn delay: %sms"] = "Atraso ao virar: %sms",
